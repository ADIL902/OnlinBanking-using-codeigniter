...
<input type="text" name="pi" class="form-control" placeholder="Enter Pin Number"><br>
 Ammount to Withdraw
<input type="text" name="aw" class="form-control" placeholder="Enter Ammount to Withdraw"><br>
<input type="submit" class="btn btn-primary" name="submit" value="withdrawl">
</form>
</div>
</div>